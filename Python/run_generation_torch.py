...
def main():
    ...
    model = XLNetLMHeadModel.from_pretrained(model_type)
    model.to('cuda')

    seq_length = adjust_length_to_model(192, max_sequence_length=model.config.max_position_embeddings)

    prompt_text = PADDING_TEXT + "On a cold winter morning, Nicholas"
