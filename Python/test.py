...
class ChunkedGenerator:
    def __init__(self, max_seq_len, max_gen_len, tokenizer, model, repetition_penalty, device, branch_threshold=.5, use_token_types=False):
        ...
        self.max_predictions = 32 # Maximum number of predictions this generator will make. After reaching this point, it will cease branching.
...
# Load model
output_dir = "C:/Users/jbetk/Documents/data/ml/saved_models/xlnet_title_generation/local_title_clustered_targets"
...
model.to(DEVICE)
generator = ChunkedGenerator(chunk_seq_len, target_pred_max_len, tokenizer, model, 100, torch.device(DEVICE), branch_threshold=.5, use_token_types=use_token_types)
